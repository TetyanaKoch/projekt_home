    ...
    <main>
        ...
        <div class="box_list1" >
            ...
            <ul>
                ...
                <li>1998 – 2012 Engagement am Zürcher Ballett unter Heinz Spoerli </li>
                <li>1997 – 1998 Engagement am Jeune Ballet de France</li>
                <li>Ausbildung an der Staatlichen Ballett Akademie Kiev</li>
            </ul>
        </div>
            <div class="box_list2">
        ...
        <aside class="sidebar">
            ...
            <p><img src="../projekt/image/teacher_bw.jpg" alt="bild" title="BILD" width="300"></p>
            <h2>XXXXXXXXXXXXX</h2>
